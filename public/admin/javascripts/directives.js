(! function() {
    ...
    function P() {
        return {
            ...
            link: function(e, n, t, i) {
                var a = (angular.element(n), { types: [], componentRestrictions: {} });
                    ...
                    8 != Object.keys(o).length && (angular.element("#locality").val(""), angular.element("#administrative_area_level_1").val(""), angular.element("#postal_code").val(""), angular.element("#country").val("")), o = o.filter(function(e) {
                        switch (e.types[0]) {
                            ...
                            case "route":
                                ...
                                break;
                            case "locality":
                                angular.element("#locality").val(e.short_name);
                                break;
                            case "administrative_area_level_1":
                                angular.element("#administrative_area_level_1").val(e.short_name);
                                break;
                            case "country":
    ...
    angular.module("TSM_ADMIN").directive("autoFocus", n), angular.module("TSM_ADMIN").directive("uniquePatientemail", t), angular.module("TSM_ADMIN").directive("date", i), angular.module("TSM_ADMIN").directive("appEnter", a), angular.module("TSM_ADMIN").directive("appLoader", r), angular.module("TSM_ADMIN").directive("toPrecision", o), angular.module("TSM_ADMIN").directive("fileBrowser", l), angular.module("TSM_ADMIN").directive("promiseBtn", c), angular.module("TSM_ADMIN").directive("confirmOnExit", s), angular.module("TSM_ADMIN").directive("clickAnywhereButHere", u), angular.module("TSM_ADMIN").directive("processingData", d), angular.module("TSM_ADMIN").directive("loadingData", f), angular.module("TSM_ADMIN").directive("accordionPanel", g), angular.module("TSM_ADMIN").directive("collapsiblePanel", p), angular.module("TSM_ADMIN").directive("accordionSearch", v), angular.module("TSM_ADMIN").directive("hasPermission", m), angular.module("TSM_ADMIN").directive("compareTo", h), angular.module("TSM_ADMIN").directive("onlyNum", k), angular.module("TSM_ADMIN").directive("passwordVerify", b), angular.module("TSM_ADMIN").directive("onFinishRender", y), angular.module("TSM_ADMIN").directive("imageonload", M), angular.module("TSM_ADMIN").directive("affectedAreas", w), angular.module("TSM_ADMIN").directive("examFindings", C), angular.module("TSM_ADMIN").directive("routeLoadingIndicator", T), angular.module("TSM_ADMIN").directive("checklistModel", S), angular.module("TSM_ADMIN").directive("selectFindings", V), angular.module("TSM_ADMIN").directive("ngLoading", A), angular.module("TSM_ADMIN").directive("googleplace", P), angular.module("TSM_ADMIN").directive("routeLoader", q), angular.module("TSM_ADMIN").directive("onlyLettersInput", x), angular.module("TSM_ADMIN").directive("onlyLettersNumberSpaceInput", E), angular.module("TSM_ADMIN").directive("ckEditor", F), angular.module("TSM_ADMIN").directive("allowPattern", R), angular.module("TSM_ADMIN").directive("onlyNumHypen", L), angular.module("TSM_ADMIN").directive("onlyNumDot", D), angular.module("TSM_ADMIN").directive("onlyDigits", j), angular.module("TSM_ADMIN").directive("siteHeader", e), S.$inject = ["$parse", "$compile"], V.$inject = ["$parse"], A.$inject = ["$compile", "$http", "$timeout"], P.$inject = [], q.$inject = [], x.$inject = [], L.$inject = [], D.$inject = [], E.$inject = [], F.$inject = [], R.$inject = [], j.$inject = []
}());