...
(function withAngular(angular, navigator) {
    ...
    ,
            generateDays = function generateDays() {
                ...
                return [
                    ...
                    '</div>',
                    '<div class="_720kb-datepicker-calendar-body">',
                    '<a href="javascript:void(0)" class="datepickerClear _720kb-datepicker-calendar-day _720kb-datepicker-disabled" ng-click="clearDatePicker()">',
                    'Clear',
                    '</a>',
                    '</div>'
    ...
    ,
            datepickerDirective = function datepickerDirective($window, $compile, $locale, $filter, $interpolate) {
                ...
                var linkingFunction = function linkingFunction($scope, element, attr, ngModel) {
                    ...
                    ,
                            setDaysInMonth = function setDaysInMonth(month, year) {
                                ...
                                if (firstDayMonthNumber === 0) {
                                    ...
                                    for (i = 1;
                                            i <= new Date(year, monthAlias, 0).getDate();
                                            i += 1) {
                    ...
                    $scope.clearDatePicker = function() {
                        ...
                        thisInput.triggerHandler('change');//just to be sure;
                        $scope.hideCalendar();
                        $scope.callback({arg1: thisInput.attr('ng-model')});
                    };
